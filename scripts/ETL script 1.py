...
num_folders = input('Enter the numer of transaction folders in total: ')
#ori_transaction = spark.sparkContext.emptyRDD()
transaction_name = input('Enter the name of the folder: ')
...
merchant_data1.write.mode('overwrite').parquet('../data/curated/merchant_data1.parquet')
